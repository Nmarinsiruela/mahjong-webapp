...
// Layer 0 base: 12 cols × 8 rows = 96
...
const POSITIONS = [
  // Layer 0 — 96 tiles (12 × 8)
  ...layer(0, range(0, 22), range(0, 14)),

  // Layer 1 — 32 tiles (8 × 4), centered
  ...layer(1, range(4, 18), range(2, 8)),

  // Layer 2 — 12 tiles (6 × 2), centered
  ...layer(2, range(6, 16), range(4, 6)),

  // Layer 3 — 4 tiles (2 × 2), top-center
  ...layer(3, range(8, 10), range(4, 6)),
];
